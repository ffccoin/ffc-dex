...
const SendPage = () => {
  ...
  return (
    <div className="bg-gray22/50 z-50 py-4 sm:px-2 px-4 rounded-2xl flex flex-col gap-y-1 scrollbar-hidden items-center justify-center w-full max-w-[512px] mx-4">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col gap-y-1">
              ...
              {token ? (
                ...
                <p className="text-center text-gray10">Please select a token</p>
              )}
            </div>
          </div>
        </div>
